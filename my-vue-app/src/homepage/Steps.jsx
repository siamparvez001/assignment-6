        ...
        <div className=' bg-gray-100 pt-40 pb-50'>
            <div className='max-w-10/12 mx-auto flex flex-col justify-center items-center '>
                ...
                <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10'>
                    <div className='shadow-xl rounded-4xl p-10 bg-white hover:-translate-y-2 transition-transform duration-300'>
                    ...
                    <div className='shadow-xl rounded-4xl bg-white p-10 hover:-translate-y-2 transition-transform duration-300'>
