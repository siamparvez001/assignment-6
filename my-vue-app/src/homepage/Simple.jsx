        ...
        <div className='py-20 '>
            <div className='flex flex-col justify-center items-center space-y-5'>
                ...
                <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-between items-center gap-5 items-stretch'>
                    <div className='shadow-accent-content hover:-translate-y-2 transition-transform duration-300 p-10 rounded-4xl w-full bg-gray-100 flex flex-col justify-between'>
                    ...
                    <div className='start hover:-translate-y-2 transition-transform duration-300 p-10 rounded-4xl w-full bg-gray-100 flex flex-col justify-between relative'>
